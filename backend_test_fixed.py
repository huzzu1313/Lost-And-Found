#!/usr/bin/env python3
"""
Lost & Found Backend API Testing Suite - Fixed Version
Tests all backend endpoints with proper NextAuth authentication
"""
...
class LostFoundAPITester:
    ...
    def test_user_registration(self):
        ...
        try:
            ...
            session = requests.Session()
            response = session.post(f"{API_BASE}/auth/register", json=regular_user_data)
        ...
        try:
            ...
            response = session.post(f"{API_BASE}/auth/register", json=admin_user_data)
        ...
        try:
            ...
            response = session.post(f"{API_BASE}/auth/register", json=invalid_data)
    ...
    def test_file_upload(self):
        ...
        try:
            ...
            response = self.regular_session.post(f"{API_BASE}/upload", files=files)
        ...
        try:
            response = self.regular_session.post(f"{API_BASE}/upload", files={})
    ...
    def test_create_item(self):
        ...
        try:
            ...
            response = self.regular_session.post(f"{API_BASE}/items", json=item_data)
        ...
        try:
            ...
            response = self.regular_session.post(f"{API_BASE}/items", json=item_data_no_image)
        ...
        try:
            ...
            response = self.regular_session.post(f"{API_BASE}/items", json=invalid_item)
    ...
    def test_get_items_with_filters(self):
        ...
        # Test search filter
        try:
            response = session.get(f"{API_BASE}/items?search=iPhone")
        ...
        try:
            response = session.get(f"{API_BASE}/items?category=Electronics")
        ...
        try:
            response = session.get(f"{API_BASE}/items?location=Central Park, NYC")
        ...
        # Test status filter
        try:
            response = session.get(f"{API_BASE}/items?status=lost")
        ...
        try:
            response = session.get(f"{API_BASE}/items?verified=true")
        ...
        try:
            response = session.get(f"{API_BASE}/items?search=iPhone&category=Electronics&status=lost")
    ...
    def test_get_single_item(self):
        ...
        try:
            response = session.get(f"{API_BASE}/items/{self.test_item_id}")
        ...
        try:
            ...
            response = session.get(f"{API_BASE}/items/{fake_id}")
    ...
    def test_update_item(self):
        ...
        try:
            ...
            response = self.regular_session.put(f"{API_BASE}/items/{self.test_item_id}", json=update_data)
        ...
        if self.admin_session:
            try:
                ...
                response = self.admin_session.put(f"{API_BASE}/items/{self.test_item_id}", json=admin_update)
        ...
        try:
            fake_id = str(uuid.uuid4())
            response = self.regular_session.put(f"{API_BASE}/items/{fake_id}", json={"title": "Update non-existent"})
    ...
    def test_delete_item(self):
        ...
        try:
            response = self.regular_session.delete(f"{API_BASE}/items/{delete_test_item_id}")
            ...
            if response.status_code == 200:
                ...
                if "deleted successfully" in data.get("message", ""):
                    ...
                    verify_response = verify_session.get(f"{API_BASE}/items/{delete_test_item_id}")
        ...
        try:
            fake_id = str(uuid.uuid4())
            response = self.regular_session.delete(f"{API_BASE}/items/{fake_id}")
        ...
        if self.admin_session:
            try:
                ...
                if response.status_code == 201:
                    ...
                    # Delete as admin
                    delete_response = self.admin_session.delete(f"{API_BASE}/items/{admin_delete_item_id}")
